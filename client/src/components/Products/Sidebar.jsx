...
const filters = [
  {
    ...
    options: [
      ...
      { value: 'sell', label: 'sell', checked: false },
  ...
  },
  {
    ...
    name: 'City',
    options: [
      { value: 'surat', label: 'Surat', checked: false },
      { value: 'baroda', label: 'Baroda', checked: false },
      { value: 'anand', label: 'Anand', checked: false },
      { value: 'ahmedabad', label: 'Ahmedabad', checked: false },
      { value: 'rajkot', label: 'Rajkot', checked: false },
    ],
  },
]
...
export default function Sidebar() {
  ...
  const handleSort = (option) => {
    ...
    // Add logic for other sorting options
  };

  return (
    <div className="bg-white w-84">
      <div>
