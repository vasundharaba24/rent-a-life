      ...
      <div className="flex flex-1">
        ...
        <div className="bg-gray-800 text-white w-64">
          <div className="p-4">
            ...
            {/* Subcategories */}
            <ul>
              {/* On click of ALL, fetch and display all product details */}
              <li className="mb-2"><a href="#" className="text-gray-300 hover:text-white" onClick={handleAllClick}>ALL</a></li>
